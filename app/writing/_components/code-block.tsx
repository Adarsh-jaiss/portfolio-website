  ...
  ({ className, children, lang = 'text', ...props }, ref) => {
    ...
    return (
      <pre
        ref={ref}
        className={cn(
          'code-block text-xs font-medium text-gray-600 bg-gray-50 p-2 pt-5 rounded-xl border relative w-full mb-12 selection:bg-theme-green-500 selection:text-white text-wrap',
          className,
        )}
        {...props}>
        {children}

          ...
          {showNewDiscussionForm ? (
            <div className="create-new-discussion-form-container flex items-center justify-between p-2 border rounded-md mb-12 gap-12">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  className="text-sm text-white flex gap-2 items-center bg-theme-green-600 border hover:bg-theme-green-700 px-1.5 py-0.5 rounded-md w-fit ml-auto active:bg-theme-green-800 disabled:opacity-50"

...
export function CommentItem({
  ...
  return (
    <div className="comment-item-container border rounded p-4 pb-12 overflow-hidden relative font-sans">
      <ReactMarkdown className="text-gray-800 text-sm whitespace-pre-wrap [&>p>code]:bg-theme-green-100 [&>p>code]:text-theme-green-500 [&>p>code]:px-1 [&>p>code]:py-0.5 [&>p>code]:rounded">
        {content}
      </ReactMarkdown>
